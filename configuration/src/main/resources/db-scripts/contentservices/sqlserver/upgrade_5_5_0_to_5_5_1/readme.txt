...
On a windows console on the command line run the following commands:
2. C:\sqlcmd  -U <username> -P <password> -d $DB_NAME -i pre-dml-upgrade-5.5.0-to-5.5.1.sql
3. C:\sqlcmd  -U <username> -P <password> -d $DB_NAME -i upgrade-5.5.0-to-5.5.1.sql
...
On a windows console on the command line run the following command:
1. C:\sqlcmd  -U <username> -P <password> -d $DB_NAME -i post-dml-upgrade-5.5.0-to-5.5.1.sql
