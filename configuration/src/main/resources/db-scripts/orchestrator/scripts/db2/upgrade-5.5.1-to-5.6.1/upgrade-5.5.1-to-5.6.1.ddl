...
alter table TB_PUBLISHING_JOBS
    add TARGET_REPOSITORY nvarchar(255);
...
alter table TB_WORK_PACKAGES
    add REPOSITORY_REFERENCE nvarchar(255);
...
REORG TABLE TB_CONTENT_REFERENCES;

update TB_CONTENT_REFERENCES set ITEM_NAME = 'contentRepository';

alter table TB_CONTENT_REFERENCES rename column ITEM_NAME to CONTEXT;

alter table TB_CONTENT_REFERENCES alter column CONTEXT set not null;
