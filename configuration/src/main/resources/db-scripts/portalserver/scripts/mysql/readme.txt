This document is meant for setting up the MySQL database.
...
- the InnoDB Storage Engine is required
...
- In the MySQL configuration file, make sure default-storage-engine is set to INNODB.
