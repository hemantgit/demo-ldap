The database migration from 5.1.2 to 5.2.0 involves running the following steps in the order mentioned:

1. Create a backup of the database.

Run these steps before the new Portal Web Application has been deployed!
2. Run pre-dml-upgrade-5.1.2-to-5.2.0.ddl
3. Run upgrade-5.1.2-to-5.2.0.dml
...
4. Run post-dml-upgrade-5.1.2-to-5.2.0.ddl
